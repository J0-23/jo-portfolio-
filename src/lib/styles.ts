...
export const sectionHead =
  "flex flex-col items-start gap-2.5 mb-13 min-[820px]:flex-row min-[820px]:items-end min-[820px]:justify-between min-[820px]:gap-4";
export const sectionTitle = "text-h2 font-extrabold tracking-[-0.01em] text-ink";
export const sectionNote =
  "font-mono text-meta text-left text-dim max-w-70 min-[820px]:text-right";

export const focusRing =
  "focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary";

export const primaryBtn = `sheen inline-flex group items-center gap-2.5 bg-primary text-white font-mono font-semibold text-ui-sm px-5.5 py-3.5 tracking-[0.02em] transition hover:-translate-y-0.5 hover:shadow-[0_0.625rem_1.5rem_rgba(36,85,201,0.22)] active:translate-y-0 active:scale-[0.98] focus-visible:outline-solid focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ink`;
